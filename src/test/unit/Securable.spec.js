...
describe('Securable', () => {
  ...
  describe('algorithmic security', () => {
    ...
    it('should work', () => {
      ...
      expect(lo.grants({ principals: teller, actions: PrimitiveAction.instanceActions() })).to.be.true()
      expect(lo.denies({ principals: teller, actions: PrimitiveAction.instanceActions() })).to.be.false()
      expect(hi.grants({ principals: teller, actions: PrimitiveAction.instanceActions() })).to.be.false()
      expect(hi.denies({ principals: teller, actions: PrimitiveAction.instanceActions() })).to.be.true()

      expect(lo.grants({ principals: manager, actions: PrimitiveAction.instanceActions() })).to.be.true()
      expect(lo.denies({ principals: manager, actions: PrimitiveAction.instanceActions() })).to.be.false()
      expect(hi.grants({ principals: manager, actions: PrimitiveAction.instanceActions() })).to.be.true()
      expect(hi.denies({ principals: manager, actions: PrimitiveAction.instanceActions() })).to.be.false()
    })
  })
})
